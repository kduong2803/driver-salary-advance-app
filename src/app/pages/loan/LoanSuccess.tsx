...
import { CheckCircle2, Bike, Calendar, ArrowRight, QrCode } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-background">
      <div className="max-w-lg mx-auto px-6 py-12 space-y-6">
        ...
        >
          <div className="w-24 h-24 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4 relative">
          ...
          <h1 className="text-3xl mb-2 text-emerald-700">Phê duyệt thành công!</h1>
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-teal-500 to-emerald-700 text-white rounded-2xl p-6 shadow-xl text-center"
        >
          ...
          <div className="mt-5 bg-white rounded-xl p-4 inline-block">
            <div className="w-24 h-24 bg-muted rounded-lg flex items-center justify-center mx-auto">
              <QrCode className="w-12 h-12 text-emerald-700" />
            </div>
        ...
        >
          ...
          <div className="space-y-3 text-sm">
            <div className="flex justify-between items-center">
              ...
              <span className="text-xl text-emerald-700">{formatCurrency(dailyPayment)}</span>
            </div>
            ...
            <div className="flex justify-between font-medium">
              ...
              <span className="text-emerald-700">{formatCurrency(totalRepay)}</span>
            </div>
          </div>

          <div className="mt-4 bg-emerald-50 rounded-xl p-3 text-sm text-muted-foreground">
