...
import { Plus, TrendingUp, Clock, CheckCircle, AlertCircle, ChevronRight, Percent, Wallet, Building2 } from "lucide-react";
...
export function Manage() {
  ...
  const advances = activeTab === "ewa" ? ewaAdvances : rbfAdvances;
